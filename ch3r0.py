...
logo = """\033[33m
                                    ...
                                    \033[34m[✔] https://github.com/cyberbyte8869   [✔]
...
## == Wordlist Functions == 
    ...
    def wlcreator(self):
        ...
        if choice == "1":
            os.system("sudo git clone https://github.com/ch3r0/wlcreator")
            self.wlcreator()
    ...
    def fastssh(self):
        ...
        if choice == "1":
            os.system("sudo git clone https://github.com/ch3r0/fastssh && cd fastssh && sudo chmod +x fastssh.sh")
    ...
    def eviltwin(self):
        ...
        if choice == "1":
            os.system("sudo git clone https://github.com/ch3r0/fakeap")
            self.eviltwin()
